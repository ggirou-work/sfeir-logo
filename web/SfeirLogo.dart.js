...
$$.TrigramAnim = {"":"Object;logo,centerSpan,timer,isOver!,_rand",
 randomLetter$0: function() {
  var i, t1, t2;
  if (this.isOver === true && $.eqB(this.get$letterContent(), "\u2630"))
    i = -1;
  else {
    t1 = this._rand;
    t2 = this.isOver === true ? 4 : 1;
    i = t1.nextInt$1(7 + t2);
  }
  if ($.geB(i, 0) && $.ltB(i, 7)) {
    if (i !== (i | 0))
      throw $.iae(i);
    if (i < 0 || i >= $.CTC6.length)
      throw $.ioore(i);
    t1 = $.CTC6[i];
  } else
    t1 = "\u2630";
  this.set$letterContent(t1);
},
 get$letterContent: function() {
  return this.centerSpan.get$innerHtml();
},
 set$letterContent: function(value) {
  this.centerSpan.set$innerHtml(value);
  return value;
},
 TrigramAnim$1: function(logo) {
  var t1, t2;
  t1 = this.logo;
  this.centerSpan = t1.query$1(".center span");
  this.timer = $.Timer_Timer$repeating(500, new $.anon(this));
  t2 = t1.get$on().get$mouseOver();
...
$$.anon = {"":"Closure;this_0",
 call$1: function(t) {
  return this.this_0.randomLetter$0();
}
};

$$.anon0 = {"":"Closure;this_1",
 call$1: function(e) {
  this.this_1.set$isOver(true);
  return true;
}
};
...
$$.Futures_wait_anon = {"":"Closure;completer_5,values_4,box_0,pos_3,result_2",
 call$1: function(value) {
  var t1, t2, remaining;
  t1 = this.values_4;
...
$$.anon2 = {"":"Closure;this_1,callback_0",
 call$0: function() {
  return this.callback_0.call$1(this.this_1);
}
};

$$.anon3 = {"":"Closure;callback_1,this_0",
 call$0: function() {
...
$.TrigramAnim$ = function(logo) {
  var t1 = new $.TrigramAnim(logo, null, null, false, $.Random_Random($.Date_Date$now().get$millisecond()));
  t1.TrigramAnim$1(logo);
  return t1;
};
...
$.TrigramAnim_letters = Isolate.$isolateProperties.CTC6;
$.TrigramAnim_theLetter = "\u2630";
...
//@ sourceMappingURL=SfeirLogo.dart.js.map